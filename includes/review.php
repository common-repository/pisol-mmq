...
v1.0.1
*/
if(!class_exists('pisol_mmq_min_max_qty_amt_review')){
class pisol_mmq_min_max_qty_amt_review{
...
new pisol_mmq_min_max_qty_amt_review('Min/Max quantity and amount plugin', 'pisol-mmq',PI_MMQ_ADD_TO_CART_URL, PI_MMQ_PRICE);
}